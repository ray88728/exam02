...
void log_vector(void){
    ...
    while(i<=99){
        ...
        place = place + sqrt((velocity_x * 0.1 + 0.5 * 9.8 * 0.01)*(velocity_x * 0.1 + 0.5 * 9.8 * 0.01) + (velocity_y * 0.1 + 0.5 * 9.8 * 0.01)*(velocity_y * 0.1 + 0.5 * 9.8 * 0.01));
        
        velocity_x = velocity_x + X[i] * 9.8 * 0.1;

        velocity_y = velocity_y + Y[i] * 9.8 * 0.1;
